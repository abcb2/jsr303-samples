...
public class GroupsWithList extends ValidationTestBase {
	...
	@Max.List({ @Max(value = 10, groups = NormalUser.class),
	...
	public void NormalUserでバリデーションしてみる() throws Exception {
		...
		diskSize = 50;
		assertThat("一般ユーザなので10超えててNG",
				validator.validate(this, NormalUser.class).size(), is(1));
	}
	...
	public void PremiumUserでバリデーションしてみる() throws Exception {
		...
		diskSize = 50;
		assertThat("プレミアムユーザなので100までOK",
				validator.validate(this, PremiumUser.class).size(), is(0));
	}
}
